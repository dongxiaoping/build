window.__require = function e(t, n, r) {
  ...
  ConfigManage: [ function(require, module, exports) {
    ...
    var RoomGameConfig_1 = require("../../common/RoomGameConfig");
    var Const_1 = require("../../common/Const");
    var Config_1 = require("../../common/Config");
    ...
    var ConfigManage = function() {
      ...
      ConfigManage.prototype.getRollDiceTime = function() {
        return RoomGameConfig_1.roomGameConfig.rollDiceTime;
      };
      ConfigManage.prototype.getDealTime = function() {
        return RoomGameConfig_1.roomGameConfig.dealTime;
      };
      ConfigManage.prototype.getBetTime = function() {
        return RoomGameConfig_1.roomGameConfig.betTime;
      };
      ConfigManage.prototype.getShowDownTime = function() {
        return RoomGameConfig_1.roomGameConfig.showDownTime;
      };
      ConfigManage.prototype.showResultKeepTime = function() {
        return RoomGameConfig_1.roomGameConfig.showResultKeepTime;
      };
      ConfigManage.prototype.getShowResultTime = function() {
        return RoomGameConfig_1.roomGameConfig.showResultTime;
      };
      ...
      ConfigManage.prototype.getCustomerWechatNum = function() {
        return RoomGameConfig_1.roomGameConfig.customerWechat;
      };
      ConfigManage.prototype.getInformMessage = function() {
        return RoomGameConfig_1.roomGameConfig.informMessage;
      };
    ...
    "../../common/Config": "Config",
    "../../common/Const": "Const",
    "../../common/RoomGameConfig": "RoomGameConfig",
  ...
  Const: [ function(require, module, exports) {
    ...
    (function(gameMemberType) {
      gameMemberType[gameMemberType["MANAGE"] = 1] = "MANAGE";
      gameMemberType[gameMemberType["PLAYER"] = 2] = "PLAYER";
      gameMemberType[gameMemberType["VISITOR"] = 3] = "VISITOR";
    ...
    var playMode;
    (function(playMode) {
      playMode[playMode["LANDLORD"] = 1] = "LANDLORD";
      playMode[playMode["TURN"] = 2] = "TURN";
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.onEnable = function() {
        ...
        this.createButton.node.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          _this.dealCreateRoom(UserManage_1.default.userInfo.id, renshu, jushu, payMode, xiazhu);
        });
      };
      NewClass.prototype.dealCreateRoom = function(userId, renshu, jushu, payMode, xiazhu) {
        return __awaiter(this, void 0, void 0, function() {
          var res, roomInfo;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, RoomManage_1.default.createRoom(userId, renshu, jushu, payMode, xiazhu) ];
        ...
        EventBus_1.eventBus.on(Const_1.EventType.LOCAL_NOTICE_EVENT, Util_1.randEventId(), function(info) {
          ...
          switch (localNoticeEventType) {
           case Const_1.LocalNoticeEventType.OPEN_CARD_FINISHED_NOTICE:
            ...
            }, ConfigManage_1.default.showResultKeepTime());
            break;
      ...
      LobbyScene.prototype.start = function() {
        ...
        this.exitButton.node.on(cc.Node.EventType.TOUCH_START, function() {
          var dialogParam = {
            sureButtonShow: true,
            cancelButtonShow: false,
            content: Const_1.WordMessage.out_action_tip,
            cancelButtonAction: null,
            sureButtonAction: null
          };
        ...
        this.customerButton.node.on(cc.Node.EventType.TOUCH_START, function() {
          ...
          var node = cc.instantiate(_this.CustomerPanel);
          node.parent = _this.node;
          node.active = true;
        });
      ...
      NewClass.prototype.onEnable = function() {
        ...
        EventBus_1.eventBus.on(Const_2.EventType.LOCAL_NOTICE_EVENT, this.localEventId, function(info) {
          if (info.type === Const_2.LocalNoticeEventType.OPEN_CARD_REQUEST_NOTICE) {
            var tableLocationType = info.info;
            _this.node.name === "MjDouble" + tableLocationType && _this.open(tableLocationType);
          }
        });
      };
      NewClass.prototype.onDisable = function() {
          ...
          switch (to) {
           case Const_1.RaceState.SHOW_DOWN:
            if (RoomManage_1.default.getEnterRoomParam().model === Const_1.EnterRoomModel.EMULATOR_ROOM) {
              ...
              }, RoomGameConfig_1.roomGameConfig.showDownTime + 1);
            }
          }
        });
  ...
  RollControlerBase: [ function(require, module, exports) {
    ...
    var WebSocketManage_1 = require("../common/WebSocketManage");
    var GameMemberManage_1 = require("../store/GameMember/GameMemberManage");
    var RoomGameConfig_1 = require("./RoomGameConfig");
    ...
    var RollControlerBase = function() {
      ...
      RollControlerBase.prototype.execDealAction = function() {
        ...
        this.roomScene.scheduleOnce(function() {
          ...
          }, RoomGameConfig_1.roomGameConfig.beginTextShowTime);
        }, RoomGameConfig_1.roomGameConfig.timeBeforeBeginText);
      };
      ...
      RollControlerBase.prototype.enterSocketRoom = function() {
        if (RoomManage_1.default.roomItem.roomState !== Const_1.roomState.CLOSE) {
          ...
          Log_1.default.i([ Const_1.ConsoleType.SOCKET, Const_1.ConsoleType.SOCKET_SEND ], "RollControllerBase/enterSocketRoom", [ "\u8fdb\u5165\u623f\u95f4\u8bf7\u6c42", notice ]);
          WebSocketManage_1.default.send(JSON.stringify(notice));
        }
      };
        ...
        EventBus_1.eventBus.on(Const_1.EventType.LOCAL_NOTICE_EVENT, eventIdOne, function(info) {
          ...
          switch (localNoticeEventType) {
           ...
           case Const_1.LocalNoticeEventType.SOCKET_CONNECT_NOTICE:
            info.info ? _this.enterSocketRoom() : _this.roomScene.scoketFailTip();
          }
        });
        var eventIdTwo = Util_1.randEventId();
        this.eventIdList.push(eventIdTwo);
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.localNoticeEvent = function() {
        ...
        EventBus_1.eventBus.on(Const_1.EventType.LOCAL_NOTICE_EVENT, this.eventIdOne, function(info) {
          ...
          switch (localNoticeEventType) {
           case Const_1.LocalNoticeEventType.DIAMOND_COUNT_CHANGE:
            _this.diamondScoreLable.string = info.info + "";
            break;
      ...
      NewClass.prototype.onDisable = function() {
        ...
        try {
          var enterRoomParam = RoomManage_1.default.getEnterRoomParam();
          if (enterRoomParam.model !== Const_1.EnterRoomModel.EMULATOR_ROOM) {
            WebSocketManage_1.default.closeWs();
            Log_1.default.d([ Const_1.ConsoleType.SOCKET ], "RollRoomScene/onDisable", [ "\u623f\u95f4\u9875\u9762\u88ab\u9500\u6bc1\uff0c\u5173\u95edsocket\u8fde\u63a5" ]);
          }
        } catch (e) {}
      };
  ...
  RoomGameConfig: [ function(require, module, exports) {
    ...
    exports.roomGameConfig = {
      timeBeforeBeginText: .5,
  ...
  RoomManage: [ function(require, module, exports) {
    ...
    var RoomManage = function() {
      ...
      RoomManage.prototype.createRoom = function(creatUserId, memberLimit, playCount, roomPay, costLimit) {
        return new Promise(function(resolve) {
          var httpUrl = Config_1.config.serverAddress + Const_1.InterfaceUrl.CREATE_ROOM;
          var paramString = "?creatUserId=" + creatUserId + "&memberLimit=" + memberLimit + "&playCount=" + playCount + "&roomPay=" + roomPay + "&costLimit=" + costLimit;
          httpUrl += paramString;
  ...
  UserManage: [ function(require, module, exports) {
    ...
    var UserManage = function() {
      ...
      UserManage.prototype.getLoginUserId = function() {
        var id = Util_1.webCookie.getItem("userId");
        return id;
      };
      ...
      WebSocketManage.prototype.onmessage = function(e) {
        ...
        switch (type) {
         case "memberInSocketRoom":
          ...
          message.userId == UserManage_1.default.userInfo.id && RoomManage_1.default.roomItem.creatUserId == message.userId && RoomManage_1.default.roomItem.roomState == Const_1.roomState.OPEN && EventBus_1.eventBus.emit(Const_1.EventType.LOCAL_NOTICE_EVENT, {
         ...
         case "memberOutRoom":
          ...
          RoomManage_1.default.roomItem.creatUserId != message.userId && RoomManage_1.default.roomItem.roomState == Const_1.roomState.OPEN ? GameMemberManage_1.default.outGameMember(message.userId) : "undefined" !== typeof GameMemberManage_1.default.gameMenmberList[message.userId] && (GameMemberManage_1.default.gameMenmberList[message.userId].state = Const_1.memberState.OffLine);
          break;
         ...
         case "raceStateChoiceLandlord":
          ...
          if (0 == message.raceNum) {
            RoomManage_1.default.roomItem.roomState = Const_1.roomState.PLAYING;
            UserManage_1.default.costDiamond(RoomManage_1.default.roomItem.id, UserManage_1.default.userInfo.id);
          }
         ...
         case "raceStateShowDown":
          ...
          }, 1e3 * (RoomGameConfig_1.roomGameConfig.showDownTime + 1));
