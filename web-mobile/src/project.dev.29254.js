    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.onEnable = function() {
        ...
        this.createButton.node.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          _this.dealCreateRoom(UserManage_1.default.userInfo.id, 3, jushu, payMode, xiazhu, thePlayMode);
        });
      };
  ...
  RollRoomScene: [ function(require, module, exports) {
    ...
    var NewClass = function(_super) {
      ...
      NewClass.prototype.start = function() {
        ...
        loglevel_1.default.getLogger(this.name).info(this.name, "\u542f\u52a8");
        this.clear();
        ...
        if (enterRoomParam) {
          ...
          loglevel_1.default.getLogger(this.name).error("url \u6ca1\u6709\u9644\u5e26\u6709\u6548\u7684\u623f\u95f4\u7528\u6237\u4fe1\u606f\uff0c\u63d0\u793a\u623f\u95f4\u4e0d\u5b58\u5728\u6216\u5df2\u5173\u95ed");
          var dialogParam = {
            sureButtonShow: true,
            cancelButtonShow: false,
            content: "\u623f\u95f4\u4e0d\u5b58\u5728\u6216\u5df2\u5173\u95ed\uff01",
      ...
      NewClass.prototype.localNoticeEvent = function() {
          ...
          switch (localNoticeEventType) {
           ...
           case Const_1.LocalNoticeEventType.VISIT_ENTER_ROOM:
            ...
            if (infoItem.userId == UserManage_1.default.userInfo.id) {
              loglevel_1.default.getLogger(_this.name).info("\u901a\u77e5\u5f53\u524d\u7528\u6237\u662f\u5426\u9700\u8981\u4ee5\u6e38\u5ba2\u8eab\u4efd\u8fdb\u5165");
              var dialogParam = {
                sureButtonShow: true,
                cancelButtonShow: true,
           ...
           case Const_1.LocalNoticeEventType.TURN_LANDLORD_LOCAL_NOTICE:
            infoItem;
            if (infoItem.userId == UserManage_1.default.userInfo.id) {
              loglevel_1.default.info("\u8f6e\u5230\u81ea\u5df1\u5f53\u5e84");
              var dialogParam = {
                sureButtonShow: true,
                cancelButtonShow: true,
                content: "\u662f\u5426\u5f53\u5e84\uff1f",
                cancelButtonAction: null,
                sureButtonAction: Const_1.TipDialogButtonAction.TURN_LANDLORD_TRUE,
                otherInfo: infoItem
              };
              _this.dialogShow(dialogParam);
            }
        ...
        EventBus_1.eventBus.on(Const_1.EventType.MEMBER_DELETE_FROM_ROOM, this.eventIdTwo, function(userId) {
          UserManage_1.default.userInfo.id == userId && _this.execBackLobby();
        });
      };
        ...
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 2:
              loglevel_1.default.getLogger(this.name).trace("\u5f00\u59cb\u767b\u5f55\u623f\u95f4", userId, roomId);
              return [ 4, RoomManage_1.default.loginRoom(userId, roomId) ];

             case 3:
              result = _a.sent();
              if (result.result === Const_1.ResponseStatus.FAIL) {
                loglevel_1.default.getLogger(this.name).error("\u767b\u5f55\u623f\u95f4\u5931\u8d25", userId, roomId);
              ...
              this.initShowAction();
              loglevel_1.default.getLogger("RollRoomScene").info("\u5f00\u59cbsocket\u8fde\u63a5");
              WebSocketManage_1.default.openWs(function() {
                loglevel_1.default.getLogger("RollRoomScene").info("socket\u8fde\u63a5\u6210\u529f\uff0c\u53d1\u9001\u8fde\u63a5\u6210\u529f\u672c\u5730\u901a\u77e5");
                EventBus_1.eventBus.emit(Const_1.EventType.LOCAL_NOTICE_EVENT, {
                  type: Const_1.LocalNoticeEventType.SOCKET_CONNECT_NOTICE,
                  info: true
                });
              }, function() {
                loglevel_1.default.getLogger("RollRoomScene").error("socket\u8fde\u63a5\u5931\u8d25\uff0c\u53d1\u9001\u8fde\u63a5\u5931\u8d25\u672c\u5730\u901a\u77e5");
                EventBus_1.eventBus.emit(Const_1.EventType.LOCAL_NOTICE_EVENT, {
                  type: Const_1.LocalNoticeEventType.SOCKET_CONNECT_NOTICE,
                  info: false
                });
      ...
      NewClass.prototype.execButtonAction = function(action) {
        try {
          switch (action) {
           ...
           case Const_1.TipDialogButtonAction.TURN_LANDLORD_TRUE:
            loglevel_1.default.info("\u5f53\u524d\u7528\u6237\u5728\u8f6e\u5e84\u4e2d\u786e\u8ba4\u5f53\u5730\u4e3b");
            var otherInfo = this.tipDialogParam.otherInfo;
            var notice = {
           ...
           case Const_1.TipDialogButtonAction.KICKOUT_MEMBER:
            ...
            if (RoomManage_1.default.roomItem.roomState == Const_1.roomState.OPEN) {
              ...
              WebSocketManage_1.default.send(JSON.stringify(notice_1));
            }
          }
          this.node.active = false;
          this.node.destroy();
      ...
      WebSocketManage.prototype.onmessage = function(e) {
        ...
        switch (type) {
         case "memberInSocketRoom":
          message;
          loglevel_1.default.info("\u63a5\u6536\u5230\u6709\u6210\u5458\u8fdb\u5165\u623f\u95f4\u901a\u77e5");
